...
public class Painter extends JFrame
{
	...
	JMenuItem newMenuItem, openMenuItem, saveMenuItem, saveAsMenuItem, exitMenuItem, undoMenuItem, redoMenuItem, foreGroundMenuItem, backGroundMenuItem, authorMenuItem;
...
/*----------------------------------------------------------------------------*/		
		...
		saveAsMenuItem.setAccelerator(KeyStroke.getKeyStroke("ctrl alt S"));
...
/*----------------------------------------------------------------------------*/	
	public class MenuButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			{
				JOptionPane.showMessageDialog(Painter.this,"Author : Himanga Madhukalya","Painter",JOptionPane.INFORMATION_MESSAGE);
				canvasPanel.repaint();
			}
...
/*----------------------------------------------------------------------------*/
	public static void main(String args[])
	{
            ...
            {
                System.err.println("Look-N-Feel can't be set." );
                ex.printStackTrace();
            }
